...
<<<<<<< HEAD
#RUN git clone --bare https://gitlab.cern.ch/hepmc/HepMC.git /data/alice/sw/MIRROR/hepmc;\
#    git ls-remote --heads /data/alice/sw/MIRROR/hepmc;

=======
>>>>>>> 3fb0b53de04e184f84ed0d15c11ce71bb793112b
